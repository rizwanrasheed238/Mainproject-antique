...
JAZZMIN_SETTINGS = {
    ...
    "site_brand": "The Medieval Store",

    # Logo to use for your site, must be present in static files, used for brand on top left
    "site_logo": "images/demos/demo-2/logo.png",
    ...
    "topmenu_links": [
        ...
        {"name": "Sales Chart", "url": "http://127.0.0.1:8000/view/", "new_window": False},
        {"name":"Sentiment Graph", "url":"http://127.0.0.1:8000/admin/antiqueapp/product/sentiment-graph/","new_window":False},
